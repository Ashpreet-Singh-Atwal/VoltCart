      ...
      <div className="profile-layout">
        <section className="panel">
          ...
          {editing ? (
            ...
            <dl className="detail-list">
              ...
              <div><dt>Account type</dt><dd>{user.role === 'ADMIN' ? 'Admin' : 'Buyer'}</dd></div>
        ...
        <section className="panel">
          ...
          <div className="quick-links">
            {user.role === 'ADMIN' ? (
              <>
                <Link to="/admin" className="btn btn--ghost btn--block">Dashboard</Link>
                <Link to="/admin/sales" className="btn btn--ghost btn--block">My sales</Link>
              </>
            ) : (
              <>
