...
const mongoUri = process.env.MONGODB_URI ?? process.env.MONGO_URI ?? 'mongodb://127.0.0.1:27017/flashsale';

export const env = {
  port: Number(required('PORT', 4000)),
  nodeEnv: required('NODE_ENV', 'development'),
  mongoUri: withDatabase(mongoUri, process.env.MONGODB_DB ?? 'flashsale'),
